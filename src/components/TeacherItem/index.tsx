...
function TeacherItem() {
    return (
        <article className="teacher-item">
                <header>
                    <img src="https://avatars2.githubusercontent.com/u/62651527?s=460&u=88f5d7501ea4e07aad56e509bcfe886288dba427&v=4" alt="Rodrigo"/>
                    <div>
                        <strong>Rodrigo de Almeida</strong>
                        <span>Física</span>
                    </div>
                </header>
                <p>
